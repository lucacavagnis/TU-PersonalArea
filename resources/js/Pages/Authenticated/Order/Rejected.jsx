...
export default function Approved(props) {
    ...
    return (
        <AuthenticatedLayout
            ...
            header={'Rifiutato'}
        >
            <Head title="Ordine rifiutato" />

            <div className="py-12">
                <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    <Tab>
                        <div className="w-2/3 text-center mr-auto ml-auto mb-4 pb-4 border-b b-grey-500">
                            <h1 className="font-bold">Hai rifiutato l'ordine</h1>
                            <p className="mb-2">L'ordine è stato rifiutato con successo. Una notifica via mail è stata inviata al referente dell'ordine</p>
